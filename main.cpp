...
//             for (double test_RD_j = 1; test_RD_j <= 500; test_RD_j += 1) {
...
//         std::tuple<double, double double> results = game.calculateRatingRes();
...
// //     Game game(player.Rating, player.RD, opp.Rating, opp.RD);
// //     // Game game(1500, 200, 1400, 30);
// //     game.calculateRatingRes();
// //     // Game game3(1492.47, 157.942, 1700, 300);
// //     // game3.calculateRatingRes();
// //     // double observed_new_r;
// //     // std::cout << "Enter the observed new rating after a win: ";
// //     // std::cin >> observed_new_r;

// //     // game.reverseEngineerRD(observed_new_r, 1);

// //     // Game game3(1278, 55, 1228, 55);
// //     // game3.calculateRatingRes();
